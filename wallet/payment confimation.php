  ...
  <tr>
    <td colspan="2" style="padding:30px 30px 10px 30px;line-height:1.8;font-family:open sans,Arial,sans-serif" align="left">
      <p>Dear, Username</p>
		...
		<p>A deposit of 1.63265352 ETH OR BTC has been received and updated your payment status. Your Gravitycash token (GVCH) will be deposited soon to your online wallet account. </p>
  </td>
  </tr>
	    <tr>
    <td colspan="2" style="padding:30px 30px 10px 30px;line-height:1.2;font-family:open sans,Arial,sans-serif" align="left">Thank you for buy Gravitycash (GVCH) .</td>
  </tr>
	  <tr>
